...
```sqf
		...
		if(!isNil "adminshowdinheiromenu")then
		{
			if(MOD_EPOCH)then
			{
			adminadd = adminadd + ["  Dar +1.000 coins",adminGiveCoins,"0","0","0","1",[0.56,0.93,0.56,1]]; // Give 1.000	
			adminadd = adminadd + ["  Dar +10.000 coins",adminGiveCoins2,"0","0","0","1",[0.56,0.93,0.56,1]]; // Give 10.000
			adminadd = adminadd + ["  Dar +100.000 coins",adminGiveCoins3,"0","0","0","1",[0.56,0.93,0.56,1]]; // Give 100.000	
			adminadd = adminadd + ["  Dar +1.000.000 coins",adminGiveCoins4,"0","0","0","1",[0.56,0.93,0.56,1]]; // Give 1.000.000
			adminadd = adminadd + ["  Dar +10.000.000 coins",adminGiveCoins5,"0","0","0","1",[0.56,0.93,0.56,1]]; // Give 10.000.000
			adminadd = adminadd + ["  Dar +20.000.000 coins",adminGiveCoins6,"0","0","0","1",[0.56,0.93,0.56,1]]; // Give 20.000.00
			adminadd = adminadd + ["  Dar +40.000.000 coins",adminGiveCoins7,"0","0","0","1",[0.56,0.93,0.56,1]]; // Give 40.000.000
			adminadd = adminadd + ["  Dar +80.000.000 coins",adminGiveCoins8,"0","0","0","1",[0.56,0.93,0.56,1]]; // Give 80.000.000
			adminadd = adminadd + ["","","0","1","0","0",[]];
			adminadd = adminadd + ["  Dar +1.000 coins para o Bank",adminGiveCoinsToBank,"0","0","0","1",[0.98,0.98,0.82,1]]; // Give 10.000 to Bank	
			adminadd = adminadd + ["  Dar +10.000 coins para o Bank",adminGiveCoinsToBank2,"0","0","0","1",[0.98,0.98,0.82,1]]; // Give 1.000.000 to Bank	
			adminadd = adminadd + ["  Dar +100.000 coins para o Bank",adminGiveCoinsToBank3,"0","0","0","1",[0.98,0.98,0.82,1]]; // Give 10.000 to Bank	
			adminadd = adminadd + ["  Dar +1.000.000 coins para o Bank",adminGiveCoinsToBank4,"0","0","0","1",[0.98,0.98,0.82,1]]; // Give 1.000.000 to Bank
			adminadd = adminadd + ["  Dar +10.000.000 coins para o Bank",adminGiveCoinsToBank5,"0","0","0","1",[0.98,0.98,0.82,1]]; // Give 1.000.000 to Ban
			adminadd = adminadd + ["  Dar +20.000.000 coins para o Bank",adminGiveCoinsToBank6,"0","0","0","1",[0.98,0.98,0.82,1]]; // Give 1.000.000 to Bank
			adminadd = adminadd + ["  Dar +40.000.000 coins para o Bank",adminGiveCoinsToBank7,"0","0","0","1",[0.98,0.98,0.82,1]]; // Give 1.000.000 to Bank
			adminadd = adminadd + ["  Dar +80.000.000 coins para o Bank",adminGiveCoinsToBank8,"0","0","0","1",[0.98,0.98,0.82,1]]; // Give 1.000.000 to Bank		
			adminadd = adminadd + ["","","0","1","0","0",[]];
			adminadd = adminadd + ["  Remover +1.000 coins",adminTakeCoins,"0","0","0","1",[0.91,0.59,0.48,1]]; // Remove 10.000
			adminadd = adminadd + ["  Remover +10.000 coins",adminTakeCoins2,"0","0","0","1",[0.91,0.59,0.48,1]]; // Remove 1.000.000
			adminadd = adminadd + ["  Remover +100.000 coins",adminTakeCoins3,"0","0","0","1",[0.91,0.59,0.48,1]]; // Remove 10.000
			adminadd = adminadd + ["  Remover +1.000.000 coins",adminTakeCoins4,"0","0","0","1",[0.91,0.59,0.48,1]]; // Remove 1.000.000
			adminadd = adminadd + ["  Remover +10.000.000 coins",adminTakeCoins5,"0","0","0","1",[0.91,0.59,0.48,1]]; // Remove 1.000.000
			adminadd = adminadd + ["  Remover +20.000.000 coins",adminTakeCoins6,"0","0","0","1",[0.91,0.59,0.48,1]]; // Remove 1.000.000
			adminadd = adminadd + ["  Remover +40.000.000 coins",adminTakeCoins7,"0","0","0","1",[0.91,0.59,0.48,1]]; // Remove 1.000.000
			adminadd = adminadd + ["  Remover +80.000.000 coins",adminTakeCoins8,"0","0","0","1",[0.91,0.59,0.48,1]]; // Remove 1.000.000
			adminadd = adminadd + ["","","0","1","0","0",[]];
			adminadd = adminadd + ["  Remover +1.000 coins do Bank",adminTakeCoinsFromBank,"0","0","0","1",[0.8,0.36,0.36,1]]; // Remove 1.000.000 from Bank		
			adminadd = adminadd + ["  Remover +10.000 coins do Bank",adminTakeCoinsFromBank2,"0","0","0","1",[0.8,0.36,0.36,1]]; // Remove 1.000.000 from Bank
			adminadd = adminadd + ["  Remover +100.000 coins do Bank",adminTakeCoinsFromBank3,"0","0","0","1",[0.8,0.36,0.36,1]]; // Remove 1.000.000 from Bank		
			adminadd = adminadd + ["  Remover +1.000.000 coins do Bank",adminTakeCoinsFromBank4,"0","0","0","1",[0.8,0.36,0.36,1]]; // Remove 1.000.000 from Bank
			adminadd = adminadd + ["  Remover +10.000.000 coins do Bank",adminTakeCoinsFromBank5,"0","0","0","1",[0.8,0.36,0.36,1]]; // Remove 1.000.000 from Bank
			adminadd = adminadd + ["  Remover +20.000.000 coins do Bank",adminTakeCoinsFromBank6,"0","0","0","1",[0.8,0.36,0.36,1]]; // Remove 1.000.000 from Bank
			adminadd = adminadd + ["  Remover +40.000.000 coins do Bank",adminTakeCoinsFromBank7,"0","0","0","1",[0.8,0.36,0.36,1]]; // Remove 1.000.000 from Bank
			adminadd = adminadd + ["  Remover +80.000.000 coins do Bank",adminTakeCoinsFromBank8,"0","0","0","1",[0.8,0.36,0.36,1]]; // Remove 1.000.000 from Bank
			adminadd = adminadd + ["","","0","1","0","0",[]];
			};
		};	
};
