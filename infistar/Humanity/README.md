...
```sqf
    _fnc = "-Humanity";
    if(isNil 'adminshowHumanitymenu')then{_fnc = "+Humanity";};
    adminadd = adminadd + [_fnc,{if(isNil "adminshowHumanitymenu")then{adminshowHumanitymenu = true;}else{adminshowHumanitymenu = nil;};call admin_update_ctrl2;},"0","0","0","0",[0.86,0.08,0.24,1]];
    if(!isNil "adminshowHumanitymenu")then
    {
        adminadd = adminadd + ["  Give 1.000 Humanity",adminHumanityPlus,"0","0","0","1",[0.56,0.93,0.56,1]];
        adminadd = adminadd + ["  Give 5.000 Humanity",adminHumanityPlus2,"0","0","0","1",[0.56,0.93,0.56,1]];
        adminadd = adminadd + ["  Give 10.000 Humanity",adminHumanityPlus3,"0","0","0","1",[0.56,0.93,0.56,1]];
        adminadd = adminadd + ["  Give 20.000 Humanity",adminHumanityPlus4,"0","0","0","1",[0.56,0.93,0.56,1]];
        adminadd = adminadd + ["  Give 40.000 Humanity",adminHumanityPlus5,"0","0","0","1",[0.56,0.93,0.56,1]];
        adminadd = adminadd + ["  Give 80.000 Humanity",adminHumanityPlus6,"0","0","0","1",[0.56,0.93,0.56,1]];
        adminadd = adminadd + ["","","0","1","0","0",[]];
        adminadd = adminadd + ["  Remove 1.000 Humanity",adminHumanityMinus,"0","0","0","1",[0.8,0.36,0.36,1]];   
        adminadd = adminadd + ["  Remove 5.000 Humanity",adminHumanityMinus2,"0","0","0","1",[0.8,0.36,0.36,1]];  
        adminadd = adminadd + ["  Remove 10.000 Humanity",adminHumanityMinus3,"0","0","0","1",[0.8,0.36,0.36,1]];
        adminadd = adminadd + ["  Remove 20.000 Humanity",adminHumanityMinus4,"0","0","0","1",[0.8,0.36,0.36,1]]; 
        adminadd = adminadd + ["  Remove 40.000 Humanity",adminHumanityMinus5,"0","0","0","1",[0.8,0.36,0.36,1]]; 
        adminadd = adminadd + ["  Remove 80.000 Humanity",adminHumanityMinus6,"0","0","0","1",[0.8,0.36,0.36,1]];
        adminadd = adminadd + ["","","0","1","0","0",[]];
    };	
```
